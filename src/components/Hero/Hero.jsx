...
const Hero = () => {
  return (
    <div className=" md:overflow-hidden lg:overflow-auto relative  bg-gradient-to-b from-black via-purple-800 to-purple-200 border top-36 border-black shadow-md w-full h-full">
