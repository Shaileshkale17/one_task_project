...
const Hero = () => {
  return (
    <div className=" overflow-y-visible   md:overflow-x-hidden lg:md:overflow-x-clip overflow-y-clip  relative  bg-gradient-to-b from-black via-purple-800 to-purple-200 border top-36 border-black shadow-md w-full h-full">
